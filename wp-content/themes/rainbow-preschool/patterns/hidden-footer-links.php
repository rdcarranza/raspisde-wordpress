...
/**
 * Title: Footer links
 * Slug: rainbow-preschool/footer-links
 * Categories: text
 * Inserter: no
 *
...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group">
		...
		printf(
			...
			esc_html__( 'Copyright %s. ', 'rainbow-preschool' ),
			esc_html( date_i18n( _x( 'Y', 'copyright date format', 'rainbow-preschool' ) ) ),
		);
		esc_html_e( 'All right reserved.', 'rainbow-preschool' );
		?>
		</p>
