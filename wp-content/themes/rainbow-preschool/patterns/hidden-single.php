...
/**
 * Title: Hidden Single
 * Slug: rainbow-preschool/hidden-single
 * Categories: single
 * Inserter: no
 *
...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0)">
	<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/header-image.jpg' ) ); ?>","id":23,"dimRatio":60,"overlayColor":"black","isUserOverlayColor":true,"minHeight":350,"align":"full","style":{"spacing":{"blockGap":"0","padding":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-group">
		<!-- wp:pattern {"slug":"rainbow-preschool/hidden-post-meta"} /-->
		<!-- wp:separator -->
	...
	<!-- wp:pattern {"slug":"rainbow-preschool/comments"} /-->
