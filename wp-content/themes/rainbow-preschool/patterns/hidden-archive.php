 ...
 * Slug: rainbow-preschool/hidden-archive
 * Categories: archive
 * Inserter: no
 *
...
<div class="wp-block-column" style="flex-basis:33.33%">
	<!-- wp:template-part {"slug":"sidebar","theme":"rainbow-preschool"} /-->
</div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group -->