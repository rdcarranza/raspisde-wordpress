...
class Preschool_Classes_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function preschool_classes_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function preschool_classes_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function preschool_classes_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function preschool_classes_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->preschool_classes_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function preschool_classes_load( $class ) {
