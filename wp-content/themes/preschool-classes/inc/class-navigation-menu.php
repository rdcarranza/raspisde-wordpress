 ...
 *
 * @package Social Media Marketing
 */

if (!class_exists('Preschool_Classes_Menu_Page')) {
    /**
     * CUSTOM PAGE WALKER
     * A custom walker for pages.
     */
    class Preschool_Classes_Menu_Page extends Walker_Page
    {
        ...
        public function start_el(&$output, $page, $depth = 0, $args = array(), $current_page = 0)
        {
            ...
            if ('' === $page->post_title) {
                ...
                $page->post_title = sprintf(__('#%d (no title)', 'preschool-classes'), $page->ID);
            }
