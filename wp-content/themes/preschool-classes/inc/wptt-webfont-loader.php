...
if ( ! class_exists( 'Preschool_Classes_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Preschool_Classes_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'preschool_classes_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function preschool_classes_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Preschool_Classes_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'preschool_classes_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function preschool_classes_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Preschool_Classes_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
