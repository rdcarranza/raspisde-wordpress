...
/**
 * Title: Search
 * Slug: legacy-preschool-kindergarten/search
 */
?>

<!-- wp:pattern {"slug":"legacy-preschool-kindergarten/search-result"} /-->
...
<p class="has-text-align-center has-body-color has-text-color has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--large)"><?php esc_html_e('Try searching for something else or refine your search terms below.', 'legacy-preschool-kindergarten'); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--large)"><?php esc_html_e('Sorry, but nothing matched your search terms.', 'legacy-preschool-kindergarten'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|large"}}},"textColor":"body"} -->
<p class="has-text-align-center has-body-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--large)"><?php esc_html_e('Try different keywords or browse our latest content below.', 'legacy-preschool-kindergarten'); ?></p>
<!-- /wp:paragraph -->
