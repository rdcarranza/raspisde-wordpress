...
/**
 * Title: Archive
 * Slug: legacy-preschool-kindergarten/archive
 */
?>
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)"><!-- wp:query-title {"type":"archive","showPrefix":false,"align":"wide","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}},"typography":{"fontWeight":"800"}},"textColor":"heading","fontSize":"xxxx-large"} /-->

<!-- wp:term-description {"align":"wide","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|xx-large"}}},"textColor":"body","fontSize":"x-large"} /-->
